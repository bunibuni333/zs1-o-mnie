        ...
        <tbody>
            ...
            foreach ($zawodnicy as $zawodnik) {
                ...
                foreach ($okrazenia as $czas) {
                    ...
                    $sekundy = $czas % 60;
                    $formatowaneOkrazenia[] = $minuty . ':' . str_pad($sekundy, 2, '0', STR_PAD_LEFT);
                }
                $minuty = floor($najlepsze / 60);
                $sekundy = $najlepsze % 60;
                $srednieFormat = $minuty . ':' . str_pad($sekundy, 2, '0', STR_PAD_LEFT);

                $minuty = floor($srednie / 60);
                $sekundy = $srednie % 60;
